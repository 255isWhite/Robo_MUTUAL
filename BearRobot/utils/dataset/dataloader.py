...
# from data.airkitchen.data_process import demo2frames_airkitchen
# from data.airkitchen.data_process import get_airkitchen_frame
...
class AIRKitchenDataset():
       def __init__(
              ...
              if True:
                     self.frame_length_dic = demo2frames_airkitchen.frame_counts_dict(json_path=datalist[0])
       ...
       def __getitem__(self, idx):
              ...
              if True:
                     img_begin_path, img_end_path = get_airkitchen_frame.get_demofixed_begin_end_frame_random(step, self.frame_length_dic)
